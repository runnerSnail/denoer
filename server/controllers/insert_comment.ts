...
export default async function insertCommit(req: ServerRequest, next) {
    if (req.url === '/api/insertCommit') {
        ...
        if(!checkParamsByArrayString(['content','gitlab_id','article_id'],params)){
            reponseUtil(req, {
        ...
        // 拼接sql
        let sql = `INSERT INTO "public"."comment"("content", "gitlab_id", "article_id", "parent_id") VALUES('${params['content']}', '${params['gitlab_id']}', ${params['article_id']}, ${params['parent_id']}) RETURNING  "comment_id";`
